...
// DESACTIVAR COMPLETAMENTE LA CARGA DE DATOS PARA EVITAR PROBLEMAS DE MEMORIA
/*
...
// FUNCIONES VACÍAS TEMPORALMENTE - SIN CARGA DE DATOS
function searchCIE10(query, limit) {
  console.log('[Terminology][Local] Búsqueda CIE10 desactivada temporalmente');
  return []; // Array vacío
}

function searchMedications(query, limit) {
  console.log('[Terminology][Local] Búsqueda medicamentos desactivada temporalmente');
  return []; // Array vacío
}
